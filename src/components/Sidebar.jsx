...
const Sidebar = ({ trendingTopics }) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-3">
          {trendingTopics.map((topic, index) => (
            ...
            >
              ...
              <span className="text-gray-700 dark:text-gray-300 text-sm group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{topic}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Quick Stats */}
      <div className="bg-gradient-to-br from-accent-500 to-primary-600 rounded-2xl p-6 text-white">
        <h4 className="font-semibold mb-4">Quick Stats</h4>
        <div className="space-y-4">
          <div>
            <div className="text-2xl font-bold">1</div>
            <div className="text-accent-100 text-sm">Posts Published</div>
          </div>
          <div>
            <div className="text-2xl font-bold">4</div>
            <div className="text-accent-100 text-sm">Categories</div>
          </div>
          <div>
            <div className="text-2xl font-bold">∞</div>
            <div className="text-accent-100 text-sm">Possibilities</div>
          </div>
        </div>
      </div>
    </div>
